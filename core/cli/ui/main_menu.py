...
class MainMenu:
    ...
    def _ensure_initialized(self) -> None:
        ...
        # 검색 엔진 초기화
        from core.cli.ui.search import init_search_engine
    ...
    def _show_scheduled_operations(self) -> None:
        """정기 작업 메뉴"""
        from functions.reports.scheduled.menu import show_scheduled_menu
    ...
    def _show_by_service_view(self) -> None:
        ...
        from core.cli.flow.steps.category import CategoryStep
...
def show_main_menu(lang: str = "ko") -> None:
    ...
    Args:
        lang: 언어 설정 ("ko" 또는 "en", 기본값: "ko")
    """
    from core.cli.i18n import set_lang, t
