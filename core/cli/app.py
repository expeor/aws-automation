...
from core.cli.i18n import t  # noqa: E402
...
class GroupedCommandsGroup(click.Group):
    ...
    def _create_path_run_command(self, tool_path: str) -> Command:
        ...
        def path_run_cmd(
            ...
            """도구 직접 실행"""
            from core.cli.headless import run_headless
...
def cli(ctx: Context, lang: str) -> None:
    ...
    from core.cli.i18n import set_lang
    ...
    if ctx.invoked_subcommand is None:
        ...
        from core.cli.ui.main_menu import show_main_menu
...
def all_cmd(ctx: Context) -> None:
    ...
    Examples:
        aa all
    """
    from core.cli.ui.main_menu import MainMenu
