...
def _create_provider_for_profile(profile: str):
    ...
    if provider_type == ProviderType.SSO_SESSION:
        ...
        return SSOSessionProvider(sso_config)
        ...
        return SSOProfileProvider(sso_config)
    ...
    def _iter_sso_sessions(self) -> Iterator[Tuple[boto3.Session, str, str]]:
        ...
        for account in target_accounts:
            ...
            for region in self._ctx.regions:
                try:
                    session = self._ctx.provider.get_session(
...
def get_context_session(
    ...
    if ctx.is_sso_session():
        ...
        return ctx.provider.get_session(
        ...
        # SSO Profile / Static
        return get_session(ctx.profile_name, region)
...
def get_current_context_info() -> Optional[Dict[str, str]]:
