            ...
            resources=[
                ResourceDef(
                    ...
                    columns=[
                        ...
                        ColumnDef("CIDR", width=18),
                        ColumnDef("State", width=12),
                        ColumnDef("Default", width=8),
                        ColumnDef("Tenancy", width=12),
                    ],
                    row_mapper=lambda v: [
                        v.account_id,
                        v.region,
                ...
                ResourceDef(
                    ...
                    columns=[
                        ...
                        ColumnDef("VPC ID", width=22),
                        ColumnDef("CIDR", width=18),
                        ColumnDef("AZ", width=15),
                        ColumnDef("Available IPs", width=12),
                    ],
                    row_mapper=lambda s: [
                        s.account_id,
                        s.region,
                ...
                ResourceDef(
                    ...
                    columns=[
                        ColumnDef("Account ID", width=15),
                        ColumnDef("Region", width=15),
                        ColumnDef("Route Table ID", width=25),
                        ColumnDef("Name", width=25),
                        ColumnDef("VPC ID", width=22),
                        ColumnDef("Main", width=8),
                        ColumnDef("Routes", width=8),
                        ColumnDef("Associations", width=12),
                    ],
                    row_mapper=lambda rt: [
                        rt.account_id,
                        rt.region,
                        rt.route_table_id,
                        rt.name,
                        rt.vpc_id,
                        "Yes" if rt.is_main else "No",
                        rt.route_count,
                        rt.association_count,
                    ],
                ),
                ResourceDef(
                ...
                ResourceDef(
                    ...
                    row_mapper=lambda eip: [
                        ...
                        eip.name,
                        eip.instance_id,
                        "Yes" if eip.is_attached else "No",
                    ],
                ),
                ResourceDef(
                    name="ENI",
                    ...
                    columns=[
                        ...
                        ColumnDef("VPC ID", width=22),
                        ColumnDef("Connected Type", width=15),
                    ],
                    row_mapper=lambda eni: [
                        eni.account_id,
                        eni.region,
                        eni.eni_id,
                        eni.status,
                ...
                ResourceDef(
                    ...
                    columns=[
                        ColumnDef("Account ID", width=15),
                        ColumnDef("Region", width=15),
                        ColumnDef("Endpoint ID", width=25),
                        ColumnDef("Type", width=12),
                        ColumnDef("State", width=12),
                        ColumnDef("Service", width=40),
                        ColumnDef("VPC ID", width=22),
                    ],
            ...
            resources=[
                ResourceDef(
                    ...
                    columns=[
                        ColumnDef("Account ID", width=15),
                        ColumnDef("Region", width=15),
                        ColumnDef("TGW ID", width=25),
                        ColumnDef("Name", width=25),
                        ColumnDef("State", width=12),
                        ColumnDef("ASN", width=12),
                    ],
                    row_mapper=lambda tgw: [
                        tgw.account_id,
                        tgw.region,
                        tgw.tgw_id,
                        tgw.name,
                ...
                ResourceDef(
                    ...
                    columns=[
                        ColumnDef("Account ID", width=15),
                        ColumnDef("Region", width=15),
                        ColumnDef("Attachment ID", width=25),
                        ColumnDef("TGW ID", width=25),
                        ColumnDef("Resource Type", width=15),
                        ColumnDef("Resource ID", width=25),
                        ColumnDef("State", width=12),
                    ],
                    row_mapper=lambda att: [
                        att.account_id,
                        att.region,
                        att.attachment_id,
                        att.tgw_id,
                ...
                ResourceDef(
                    ...
                    columns=[
                        ColumnDef("Account ID", width=15),
                        ColumnDef("Region", width=15),
                        ColumnDef("VPN Gateway ID", width=25),
                        ColumnDef("Name", width=25),
                        ColumnDef("State", width=12),
                        ColumnDef("Type", width=12),
                    ],
                    row_mapper=lambda vgw: [
                        vgw.account_id,
                        vgw.region,
                        vgw.vpn_gateway_id,
                        vgw.name,
                ...
                ResourceDef(
                    ...
                    columns=[
                        ColumnDef("Account ID", width=15),
                        ColumnDef("Region", width=15),
                        ColumnDef("VPN Connection ID", width=25),
                        ColumnDef("Name", width=25),
                        ColumnDef("State", width=12),
                        ColumnDef("CGW ID", width=22),
                    ],
                    row_mapper=lambda vpn: [
                        vpn.account_id,
                        vpn.region,
                ...
                ResourceDef(
                    ...
                    row_mapper=lambda nacl: [
                        ...
                        nacl.inbound_rule_count,
                        nacl.outbound_rule_count,
                    ],
                ),
                ResourceDef(
                    name="VPC Peering",
                    ...
                    columns=[
                        ColumnDef("Account ID", width=15),
                        ColumnDef("Region", width=15),
                        ColumnDef("Peering ID", width=25),
                        ColumnDef("Status", width=12),
                        ColumnDef("Requester VPC", width=22),
                        ColumnDef("Accepter VPC", width=22),
                    ],
                    row_mapper=lambda pcx: [
                        pcx.account_id,
                        pcx.region,
                        pcx.peering_id,
                        pcx.status,
                        pcx.requester_vpc_id,
                        pcx.accepter_vpc_id,
                    ],
                ),
            ],
            ...
            resources=[
                ...
                ResourceDef(
                    ...
                    columns=[
                        ColumnDef("Account ID", width=15),
                        ColumnDef("Region", width=15),
                        ColumnDef("Volume ID", width=22),
                        ColumnDef("Name", width=20),
                        ColumnDef("Size (GB)", width=10),
                        ColumnDef("Type", width=10),
                        ColumnDef("State", width=12),
                        ColumnDef("Instance ID", width=20),
                    ],
                ...
                ResourceDef(
                    ...
                    columns=[
                        ColumnDef("Account ID", width=15),
                        ColumnDef("Region", width=15),
                        ColumnDef("Function Name", width=30),
                        ColumnDef("Runtime", width=15),
                        ColumnDef("Memory", width=10),
                        ColumnDef("Timeout", width=10),
                    ],
                    row_mapper=lambda fn: [
                        fn.account_id,
                        fn.region,
                        fn.function_name,
                        fn.runtime,
                ...
                ResourceDef(
                    ...
                    columns=[
                        ColumnDef("Account ID", width=15),
                        ColumnDef("Region", width=15),
                        ColumnDef("Cluster Name", width=30),
                        ColumnDef("Status", width=12),
                        ColumnDef("Running Tasks", width=12),
                        ColumnDef("Services", width=10),
                    ],
                    row_mapper=lambda c: [
                        c.account_id,
                        c.region,
                ...
                ResourceDef(
                    ...
                    columns=[
                        ColumnDef("Account ID", width=15),
                        ColumnDef("Region", width=15),
                        ColumnDef("Service Name", width=30),
                        ColumnDef("Status", width=12),
                        ColumnDef("Desired", width=10),
                        ColumnDef("Running", width=10),
                    ],
                    row_mapper=lambda s: [
                        s.account_id,
                        s.region,
                ...
                ResourceDef(
                    ...
                    columns=[
                        ColumnDef("Account ID", width=15),
                        ColumnDef("Region", width=15),
                        ColumnDef("ASG Name", width=30),
                        ColumnDef("Min", width=6),
                        ColumnDef("Max", width=6),
                        ColumnDef("Desired", width=8),
                        ColumnDef("Current", width=8),
                    ],
                    row_mapper=lambda asg: [
                        asg.account_id,
                        asg.region,
                        asg.asg_name,
                        asg.min_size,
                ...
                ResourceDef(
                    ...
                    columns=[
                        ColumnDef("Account ID", width=15),
                        ColumnDef("Region", width=15),
                        ColumnDef("Template ID", width=22),
                        ColumnDef("Name", width=25),
                        ColumnDef("Version", width=10),
                        ColumnDef("Instance Type", width=15),
                    ],
                    row_mapper=lambda lt: [
                        lt.account_id,
                        lt.region,
                        lt.template_id,
                        lt.template_name,
                ...
                ResourceDef(
                    ...
                    columns=[
                        ColumnDef("Account ID", width=15),
                        ColumnDef("Region", width=15),
                        ColumnDef("Cluster Name", width=25),
                        ColumnDef("Status", width=12),
                        ColumnDef("Version", width=10),
                        ColumnDef("VPC ID", width=22),
                    ],
                    row_mapper=lambda eks: [
                        eks.account_id,
                        eks.region,
                        eks.cluster_name,
                        eks.status,
                ...
                ResourceDef(
                    ...
                    columns=[
                        ColumnDef("Account ID", width=15),
                        ColumnDef("Region", width=15),
                        ColumnDef("Cluster", width=20),
                        ColumnDef("Node Group", width=25),
                        ColumnDef("Status", width=12),
                        ColumnDef("Desired", width=8),
                    ],
                    row_mapper=lambda ng: [
                        ng.account_id,
                        ng.region,
                        ng.cluster_name,
                        ng.nodegroup_name,
                ...
                ResourceDef(
                    ...
                    columns=[
                        ColumnDef("Account ID", width=15),
                        ColumnDef("Region", width=15),
                        ColumnDef("Image ID", width=22),
                        ColumnDef("Name", width=40),
                        ColumnDef("State", width=12),
                        ColumnDef("Architecture", width=12),
                    ],
                    row_mapper=lambda ami: [
                        ami.account_id,
                        ami.region,
                        ami.image_id,
                        ami.name,
                ...
                ResourceDef(
                    ...
                    columns=[
                        ColumnDef("Account ID", width=15),
                        ColumnDef("Region", width=15),
                        ColumnDef("Snapshot ID", width=22),
                        ColumnDef("Volume ID", width=22),
                        ColumnDef("Size (GB)", width=10),
                        ColumnDef("State", width=12),
                    ],
                    row_mapper=lambda snap: [
                        snap.account_id,
                        snap.region,
                        snap.snapshot_id,
                        snap.volume_id,
            ...
            resources=[
                ResourceDef(
                    ...
                    columns=[
                        ColumnDef("Account ID", width=15),
                        ColumnDef("Region", width=15),
                        ColumnDef("DB Instance ID", width=25),
                        ColumnDef("Class", width=15),
                        ColumnDef("Engine", width=12),
                        ColumnDef("Status", width=12),
                        ColumnDef("Multi-AZ", width=10),
                    ],
                    row_mapper=lambda db: [
                        db.account_id,
                        db.region,
                        db.db_instance_id,
                ...
                ResourceDef(
                    ...
                    columns=[
                        ColumnDef("Account ID", width=15),
                        ColumnDef("Region", width=15),
                        ColumnDef("Cluster ID", width=25),
                        ColumnDef("Engine", width=15),
                        ColumnDef("Status", width=12),
                        ColumnDef("Members", width=10),
                    ],
                    row_mapper=lambda c: [
                        c.account_id,
                        c.region,
                ...
                ResourceDef(
                    ...
                    columns=[
                        ColumnDef("Account ID", width=15),
                        ColumnDef("Region", width=15),
                        ColumnDef("Bucket Name", width=40),
                        ColumnDef("Versioning", width=12),
                        ColumnDef("Encryption", width=12),
                        ColumnDef("Public Block", width=12),
                    ],
                    row_mapper=lambda b: [
                        b.account_id,
                        b.region,
                        ...
                        b.versioning_status,
                        b.encryption_type,
                        "Yes" if b.public_access_block else "No",
                    ],
                ),
                ResourceDef(
                    name="DynamoDB Table",
                    ...
                    columns=[
                        ColumnDef("Account ID", width=15),
                        ColumnDef("Region", width=15),
                        ColumnDef("Table Name", width=30),
                        ColumnDef("Status", width=12),
                        ColumnDef("Billing Mode", width=12),
                        ColumnDef("Items", width=12),
                    ],
                    row_mapper=lambda t: [t.account_id, t.region, t.table_name, t.status, t.billing_mode, t.item_count],
                ),
                ResourceDef(
                    ...
                    columns=[
                        ...
                        ColumnDef("Region", width=15),
                        ColumnDef("Cluster ID", width=25),
                        ColumnDef("Engine", width=10),
                        ColumnDef("Node Type", width=18),
                        ColumnDef("Status", width=12),
                    ],
                    row_mapper=lambda c: [c.account_id, c.region, c.cluster_id, c.engine, c.node_type, c.status],
                ),
                ResourceDef(
                    ...
                    columns=[
                        ...
                        ColumnDef("Region", width=15),
                        ColumnDef("Cluster ID", width=25),
                        ColumnDef("Node Type", width=15),
                        ColumnDef("Status", width=12),
                        ColumnDef("Nodes", width=8),
                    ],
                    row_mapper=lambda c: [
                        c.account_id,
                        c.region,
                ...
                ResourceDef(
                    ...
                    columns=[
                        ColumnDef("Account ID", width=15),
                        ColumnDef("Region", width=15),
                        ColumnDef("File System ID", width=22),
                        ColumnDef("Name", width=25),
                        ColumnDef("State", width=12),
                        ColumnDef("Performance", width=15),
                    ],
                    row_mapper=lambda fs: [
                        fs.account_id,
                        fs.region,
                        fs.file_system_id,
                        fs.name,
                ...
                ResourceDef(
                    ...
                    columns=[
                        ...
                        ColumnDef("File System ID", width=22),
                        ColumnDef("Type", width=15),
                        ColumnDef("Lifecycle", width=12),
                        ColumnDef("Storage (GB)", width=12),
                    ],
                    row_mapper=lambda fs: [
                        fs.account_id,
                        fs.region,
            ...
            resources=[
                ResourceDef(
                    ...
                    row_mapper=lambda sg: [
                        ...
                        sg.vpc_id,
                        sg.rule_count,
                        "Yes" if sg.has_public_access else "No",
                    ],
                ),
                ResourceDef(
                    name="KMS Key",
                    ...
                    columns=[
                        ColumnDef("Account ID", width=15),
                        ColumnDef("Region", width=15),
                        ColumnDef("Key ID", width=38),
                        ColumnDef("Alias", width=30),
                        ColumnDef("State", width=12),
                        ColumnDef("Manager", width=10),
                    ],
                    row_mapper=lambda k: [k.account_id, k.region, k.key_id, k.alias, k.key_state, k.key_manager],
                ),
                ResourceDef(
                    name="Secret",
                    ...
                    columns=[
                        ColumnDef("Account ID", width=15),
                        ColumnDef("Region", width=15),
                        ColumnDef("Secret Name", width=40),
                        ColumnDef("Rotation", width=10),
                    ],
                ...
                ResourceDef(
                    ...
                    columns=[
                        ColumnDef("Account ID", width=15),
                        ColumnDef("Role Name", width=40),
                        ColumnDef("Path", width=15),
                        ColumnDef("Attached Policies", width=15),
                ...
                ResourceDef(
                    ...
                    columns=[
                        ColumnDef("Account ID", width=15),
                        ColumnDef("User Name", width=30),
                        ColumnDef("Console", width=10),
                        ColumnDef("Access Keys", width=12),
                        ColumnDef("MFA", width=8),
                    ],
                    row_mapper=lambda u: [
                        u.account_id,
                        u.user_name,
                        "Yes" if u.has_console_access else "No",
                        u.access_key_count,
                ...
                ResourceDef(
                    ...
                    columns=[
                        ColumnDef("Account ID", width=15),
                        ColumnDef("Policy Name", width=40),
                        ColumnDef("Path", width=15),
                        ColumnDef("Attachments", width=12),
                    ],
                ...
                ResourceDef(
                    ...
                    columns=[
                        ColumnDef("Account ID", width=15),
                        ColumnDef("Region", width=15),
                        ColumnDef("Domain Name", width=40),
                        ColumnDef("Status", width=12),
                        ColumnDef("Type", width=12),
                        ColumnDef("In Use", width=8),
                    ],
                    row_mapper=lambda c: [
                        c.account_id,
                        c.region,
                ...
                ResourceDef(
                    ...
                    columns=[
                        ...
                        ColumnDef("Scope", width=12),
                        ColumnDef("Rules", width=8),
                        ColumnDef("Default Action", width=12),
                    ],
                    row_mapper=lambda w: [w.account_id, w.region, w.name, w.scope, w.rule_count, w.default_action],
                ),
            ],
        ),
        # =====================================================================
        ...
        CategoryDef(
            ...
            resources=[
                ResourceDef(
                    ...
                    columns=[
                        ColumnDef("Account ID", width=15),
                        ColumnDef("Distribution ID", width=16),
                        ColumnDef("Domain Name", width=40),
                        ColumnDef("Status", width=12),
                        ColumnDef("Enabled", width=10),
                        ColumnDef("Origins", width=8),
                    ],
                    row_mapper=lambda d: [
                        d.account_id,
                        d.distribution_id,
                ...
                ResourceDef(
                    ...
                    columns=[
                        ColumnDef("Account ID", width=15),
                        ColumnDef("Zone ID", width=16),
                        ColumnDef("Name", width=35),
                        ColumnDef("Records", width=10),
            ...
            resources=[
                ResourceDef(
                    ...
                    columns=[
                        ...
                        ColumnDef("Name", width=30),
                        ColumnDef("Type", width=12),
                        ColumnDef("Scheme", width=12),
                        ColumnDef("State", width=10),
                    ],
                    row_mapper=lambda lb: [lb.account_id, lb.region, lb.name, lb.lb_type, lb.scheme, lb.state],
                ),
                ResourceDef(
                    name="Target Group",
            ...
            resources=[
                ResourceDef(
                    ...
                    columns=[
                        ColumnDef("Account ID", width=15),
                        ColumnDef("Region", width=15),
                        ColumnDef("Topic Name", width=40),
                        ColumnDef("Subscriptions", width=12),
                ...
                ResourceDef(
                    ...
                    columns=[
                        ColumnDef("Account ID", width=15),
                        ColumnDef("Region", width=15),
                        ColumnDef("Queue Name", width=40),
                        ColumnDef("Messages", width=12),
                        ColumnDef("FIFO", width=8),
                    ],
                    row_mapper=lambda q: [
                        q.account_id,
                ...
                ResourceDef(
                    ...
                    columns=[
                        ColumnDef("Account ID", width=15),
                        ColumnDef("Region", width=15),
                        ColumnDef("Rule Name", width=35),
                        ColumnDef("Event Bus", width=20),
                        ColumnDef("State", width=10),
                        ColumnDef("Targets", width=8),
                    ],
                    row_mapper=lambda r: [
                        r.account_id,
                        r.region,
                ...
                ResourceDef(
                    ...
                    columns=[
                        ColumnDef("Account ID", width=15),
                        ColumnDef("Region", width=15),
                        ColumnDef("API ID", width=15),
                        ColumnDef("Name", width=30),
                        ColumnDef("Type", width=10),
                        ColumnDef("Endpoint", width=12),
                    ],
                    row_mapper=lambda api: [
                        api.account_id,
                        api.region,
                        api.api_id,
                        api.name,
            ...
            resources=[
                ResourceDef(
                    ...
                    columns=[
                        ColumnDef("Account ID", width=15),
                        ColumnDef("Region", width=15),
                        ColumnDef("Alarm Name", width=35),
                        ColumnDef("State", width=10),
                        ColumnDef("Metric", width=25),
                        ColumnDef("Namespace", width=20),
                    ],
                    row_mapper=lambda a: [
                        a.account_id,
                        a.region,
                ...
                ResourceDef(
                    ...
                    columns=[
                        ColumnDef("Account ID", width=15),
                        ColumnDef("Region", width=15),
                        ColumnDef("Log Group Name", width=50),
                        ColumnDef("Retention", width=12),
                        ColumnDef("Stored Bytes", width=15),
                    ],
                    row_mapper=lambda lg: [
                        lg.account_id,
                        lg.region,
                        lg.log_group_name,
                        lg.retention_in_days or "Never",
                        lg.stored_bytes,
                    ],
                ),
            ],
            ...
            resources=[
                ResourceDef(
                    ...
                    columns=[
                        ColumnDef("Account ID", width=15),
                        ColumnDef("Region", width=15),
                        ColumnDef("Stream Name", width=35),
                        ColumnDef("Status", width=12),
                        ColumnDef("Shards", width=8),
                        ColumnDef("Retention (hrs)", width=14),
                    ],
                    row_mapper=lambda s: [
                        s.account_id,
                        s.region,
                ...
                ResourceDef(
                    ...
                    columns=[
                        ...
                        ColumnDef("Stream Name", width=35),
                        ColumnDef("Status", width=12),
                        ColumnDef("Source", width=15),
                        ColumnDef("Destination", width=15),
                    ],
                    row_mapper=lambda f: [
                        f.account_id,
                        f.region,
                        f.delivery_stream_name,
                        f.delivery_stream_status,
                        f.source_type,
                        f.destination_type,
                    ],
                ),
                ResourceDef(
                    ...
                    columns=[
                        ColumnDef("Account ID", width=15),
                        ColumnDef("Region", width=15),
                        ColumnDef("Database Name", width=35),
                        ColumnDef("Catalog ID", width=15),
                        ColumnDef("Tables", width=10),
                    ],
                    row_mapper=lambda db: [db.account_id, db.region, db.database_name, db.catalog_id, db.table_count],
                ),
            ],
        ),
        # =====================================================================
            ...
            resources=[
                ResourceDef(
                    ...
                    columns=[
                        ColumnDef("Account ID", width=15),
                        ColumnDef("Region", width=15),
                        ColumnDef("Stack Name", width=35),
                        ColumnDef("Status", width=20),
                ...
                ResourceDef(
                    ...
                    columns=[
                        ColumnDef("Account ID", width=15),
                        ColumnDef("Region", width=15),
                        ColumnDef("Pipeline Name", width=35),
                        ColumnDef("Version", width=10),
                ...
                ResourceDef(
                    ...
                    columns=[
                        ColumnDef("Account ID", width=15),
                        ColumnDef("Region", width=15),
                        ColumnDef("Project Name", width=35),
                        ColumnDef("Source Type", width=15),
            ...
            resources=[
                ResourceDef(
                    ...
                    columns=[
                        ColumnDef("Account ID", width=15),
                        ColumnDef("Region", width=15),
                        ColumnDef("Vault Name", width=35),
                        ColumnDef("Recovery Points", width=15),
