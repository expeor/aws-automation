...
class TestPrintRule:
    ...
    def test_rule_without_title(self):
        """제목 없는 구분선"""
        from core.cli.ui.console import print_rule
...
class TestPrintResultTree:
    ...
    def test_basic_tree(self):
        """기본 트리 출력"""
        from core.cli.ui.console import print_result_tree
...
class TestPrintErrorTree:
    ...
    def test_basic_errors(self):
        """기본 에러 트리"""
        from core.cli.ui.console import print_error_tree
...
class TestPrintStatColumns:
    ...
    def test_two_panels(self):
        """두 개 패널"""
        from core.cli.ui.console import print_stat_columns
...
class TestPrintExecutionSummary:
    ...
    def test_full_summary(self):
        """전체 요약"""
        from core.cli.ui.console import print_execution_summary
...
class TestPrintResultsJson:
    ...
    def test_basic_json(self):
        """기본 JSON 출력"""
        from core.cli.ui.console import print_results_json
...
class TestToolStartComplete:
    ...
    def test_tool_start(self):
        """도구 시작 출력"""
        from core.cli.ui.console import print_tool_start
    ...
    def test_tool_complete(self):
        """도구 완료 출력"""
        from core.cli.ui.console import print_tool_complete
