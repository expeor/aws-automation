...
from analyzers.sso.sso_audit import _create_output_directory, _print_summary, run
...
class TestRun:
    ...
    @patch("analyzers.sso.sso_audit.open_in_explorer")
    @patch("analyzers.sso.sso_audit.SSOExcelReporter")
    @patch("analyzers.sso.sso_audit.SSOAnalyzer")
    @patch("analyzers.sso.sso_audit.SSOCollector")
    @patch("analyzers.sso.sso_audit.SessionIterator")
    @patch("analyzers.sso.sso_audit.get_client")
    def test_run_successful(
        ...
        with patch("shared.io.output.print_report_complete"):
            run(mock_context)
