...
from analyzers.tag_editor.native_api.cloudwatch_logs import (
    _get_log_group_arn,
    apply_log_group_tag,
    collect_log_group_tags,
)
from analyzers.tag_editor.types import MAP_TAG_KEY, ResourceTagInfo, TagOperationResult
...
class TestCollectLogGroupTags:
    ...
    @patch("analyzers.tag_editor.native_api.cloudwatch_logs.get_client")
