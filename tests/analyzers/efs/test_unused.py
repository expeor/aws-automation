...
def make_efs_info(
    ...
    """EFSInfo 테스트 데이터 생성"""
    from analyzers.efs.unused import EFSInfo
...
class TestCollectEfsFilesystems:
    ...
    def test_collect_normal(self, mock_boto3_session):
        """정상 수집 케이스"""
        from analyzers.efs.unused import collect_efs_filesystems
...
class TestAnalyzeFilesystems:
    ...
    def test_analyze_normal(self):
        """정상 파일시스템 분석"""
        from analyzers.efs.unused import FileSystemStatus, analyze_filesystems
    ...
    def test_analyze_empty_input(self):
        """빈 입력 케이스"""
        from analyzers.efs.unused import analyze_filesystems
...
class TestRun:
    ...
    @patch("analyzers.efs.unused.parallel_collect")
    @patch("analyzers.efs.unused.generate_report")
    @patch("analyzers.efs.unused.open_in_explorer")
    def test_run_success(self, mock_explorer, mock_report, mock_parallel, mock_context):
        """정상 실행"""
        from analyzers.efs.unused import EFSAnalysisResult, run
    ...
    def test_run_no_results(self, mock_parallel, mock_context):
        """결과 없음"""
        from analyzers.efs.unused import run
...
class TestGenerateReport:
    ...
    def test_generate_report_creates_file(self, tmp_path):
        """보고서 파일 생성 테스트"""
        from analyzers.efs.unused import EFSAnalysisResult, EFSFinding, FileSystemStatus, generate_report
    ...
    def test_generate_report_empty_results(self, tmp_path):
        """빈 결과 보고서"""
        from analyzers.efs.unused import generate_report
...
class TestCollectAndAnalyze:
    ...
    @patch("analyzers.efs.unused.collect_efs_filesystems")
    @patch("analyzers.efs.unused.analyze_filesystems")
    def test_collect_and_analyze_success(self, mock_analyze, mock_collect, mock_boto3_session):
        """정상 수집 및 분석"""
        from analyzers.efs.unused import EFSAnalysisResult, _collect_and_analyze
    ...
    def test_collect_and_analyze_no_filesystems(self, mock_collect, mock_boto3_session):
        """파일시스템 없음"""
        from analyzers.efs.unused import _collect_and_analyze
