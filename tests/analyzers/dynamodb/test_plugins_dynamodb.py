...
from analyzers.dynamodb.capacity_mode import (
...
class TestTableInfo:
    ...
    @patch("analyzers.dynamodb.unused.get_dynamodb_monthly_cost")
...
class TestTableCapacityInfo:
    ...
    @patch("analyzers.dynamodb.capacity_mode.get_dynamodb_monthly_cost")
    ...
    @patch("analyzers.dynamodb.capacity_mode.estimate_ondemand_cost")
