...
class TestPrintSummary:
    ...
    def test_empty_stats_list(self, mock_console):
        """빈 통계 리스트"""
        from analyzers.vpc.nat_audit import _print_summary
...
class TestCollectAndAnalyze:
    ...
    @patch("analyzers.vpc.nat_audit.NATAnalyzer")
    @patch("analyzers.vpc.nat_audit.NATCollector")
    def test_no_nat_gateways(self, mock_collector_cls, mock_analyzer_cls):
        """NAT Gateway가 없는 경우"""
        from analyzers.vpc.nat_audit import _collect_and_analyze
