...
from analyzers.cost.pricing.constants import DEFAULT_PRICES, HOURS_PER_MONTH
...
class TestSageMakerPricing:
    ...
    def mock_pricing_service(self, sample_sagemaker_prices):
        """Mock PricingService"""
        with patch("analyzers.cost.pricing.sagemaker.pricing_service") as mock_service:
    ...
    def test_get_sagemaker_price(self, mock_pricing_service, sample_sagemaker_prices):
        ...
        from analyzers.cost.pricing.sagemaker import get_sagemaker_price
    ...
    def test_get_sagemaker_monthly_cost(self, mock_pricing_service, sample_sagemaker_prices):
        """SageMaker 월간 비용 계산"""
        from analyzers.cost.pricing.sagemaker import get_sagemaker_monthly_cost
    ...
    def test_get_sagemaker_prices(self, mock_pricing_service, sample_sagemaker_prices):
        """모든 SageMaker 가격 조회"""
        from analyzers.cost.pricing.sagemaker import get_sagemaker_prices
    ...
    def test_get_sagemaker_prices_bulk_alias(self):
        ...
        from analyzers.cost.pricing.sagemaker import get_sagemaker_prices, get_sagemaker_prices_bulk
