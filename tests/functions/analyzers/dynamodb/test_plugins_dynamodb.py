...
from functions.analyzers.dynamodb.capacity_mode import (
...
class TestTableInfo:
    ...
    @patch("functions.analyzers.dynamodb.unused.get_dynamodb_monthly_cost")
...
class TestTableCapacityInfo:
    ...
    @patch("functions.analyzers.dynamodb.capacity_mode.get_dynamodb_monthly_cost")
    ...
    @patch("functions.analyzers.dynamodb.capacity_mode.estimate_ondemand_cost")
