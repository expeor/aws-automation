...
from functions.analyzers.ec2.eip_audit import (
    EIPInfo,
    _analyze_single_eip,
    analyze_eips,
)
from functions.analyzers.ec2.eip_audit import Severity as EIPSeverity
from functions.analyzers.ec2.eip_audit import UsageStatus as EIPUsageStatus
...
class TestEC2UnusedAnalysis:
    ...
    def test_instance_info_estimated_monthly_cost(self):
        """인스턴스 비용 추정 테스트"""
        with patch("functions.analyzers.ec2.unused.get_ec2_monthly_cost", return_value=50.0):
            # Linux 인스턴스
    ...
    def test_analyze_instances_stopped(self):
        ...
        with patch("functions.analyzers.ec2.unused.get_ec2_monthly_cost", return_value=30.0):
    ...
    def test_analyze_instances_normal(self):
        ...
        with patch("functions.analyzers.ec2.unused.get_ec2_monthly_cost", return_value=100.0):
            result = analyze_instances(instances, "123456789012", "test-account", "ap-northeast-2")
