...
class TestALBLogAnalyzerStructure:
    ...
    def mock_duckdb(self):
        """Mock DuckDB module"""
        with patch("functions.reports.log_analyzer.alb_log_analyzer.duckdb") as mock:
            mock_conn = MagicMock()
    ...
    def test_analyzer_import(self):
        ...
        try:
            from functions.reports.log_analyzer.alb_log_analyzer import ALBLogAnalyzer
    ...
    @patch("functions.reports.log_analyzer.alb_log_analyzer.duckdb")
    ...
    def test_analyzer_invalid_timezone(self, mock_duckdb):
        ...
        with patch("functions.reports.log_analyzer.alb_log_analyzer.logger") as mock_logger:
            analyzer = ALBLogAnalyzer(
                s3_client=mock_s3_client,
                bucket_name="test-bucket",
                prefix="logs/alb",
...
class TestDuckDBCheck:
    ...
    def test_check_duckdb_available(self):
        ...
        try:
            from functions.reports.log_analyzer.alb_log_analyzer import _check_duckdb
    ...
    @patch("functions.reports.log_analyzer.alb_log_analyzer.duckdb", None)
