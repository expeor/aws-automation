...
from plugins.tag_editor.map_audit import _aggregate_stats, _collect_and_analyze
from plugins.tag_editor.map_apply import apply_map_tag
from plugins.tag_editor.native_api import NATIVE_API_RESOURCE_TYPES
from plugins.tag_editor.types import (
    MAP_TAG_KEY,
...
class TestHybridApplyMapTag:
    ...
    @patch("plugins.tag_editor.map_apply.apply_log_group_tag")
    @patch("plugins.tag_editor.map_apply.apply_s3_bucket_tag")
    @patch("plugins.tag_editor.map_apply.get_client")
    def test_routes_to_correct_api(self, mock_get_client, mock_s3_apply, mock_logs_apply):
        ...
        # 각 Native API 결과 모킹
        from plugins.tag_editor.types import MapTagApplyResult
...
class TestHybridCollect:
    ...
    @patch("plugins.tag_editor.map_audit.collect_s3_bucket_tags")
    @patch("plugins.tag_editor.map_audit.collect_log_group_tags")
    @patch("plugins.tag_editor.map_audit.collect_resources_with_tags")
