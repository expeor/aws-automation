...
from plugins.cost.pricing.constants import HOURS_PER_MONTH
...
class TestEC2Pricing:
    ...
    def mock_pricing_service(self, sample_ec2_prices):
        """Mock PricingService"""
        with patch("plugins.cost.pricing.ec2.pricing_service") as mock_service:
    ...
    def test_get_ec2_monthly_cost(self, mock_pricing_service, sample_ec2_prices):
        """EC2 월간 비용 계산"""
        from plugins.cost.pricing.ec2 import get_ec2_monthly_cost
    ...
    def test_get_ec2_prices(self, mock_pricing_service, sample_ec2_prices):
        """모든 EC2 가격 조회"""
        from plugins.cost.pricing.ec2 import get_ec2_prices
    ...
    def test_get_ec2_prices_bulk_alias(self, mock_pricing_service, sample_ec2_prices):
        ...
        from plugins.cost.pricing.ec2 import get_ec2_prices, get_ec2_prices_bulk
