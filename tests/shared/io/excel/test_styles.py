...
class TestStyles:
    ...
    def test_danger_style(self):
        ...
        from core.shared.io.excel.styles import Styles
...
class TestRowStyle:
    ...
    def test_data_style(self):
        """data 행 스타일"""
        from core.shared.io.excel.styles import RowStyle
...
class TestStyleFunctions:
    ...
    def test_get_header_font(self):
        """헤더 폰트가 올바르게 생성됨"""
        from core.shared.io.excel.styles import get_header_font
    ...
    def test_get_data_font(self):
        """데이터 폰트가 올바르게 생성됨"""
        from core.shared.io.excel.styles import get_data_font
    ...
    def test_get_summary_font(self):
        """요약 폰트가 올바르게 생성됨"""
        from core.shared.io.excel.styles import get_summary_font
    ...
    def test_get_header_fill(self):
        """헤더 채우기가 올바르게 생성됨"""
        from core.shared.io.excel.styles import get_header_fill
    ...
    def test_get_summary_fill(self):
        """요약 채우기가 올바르게 생성됨"""
        from core.shared.io.excel.styles import get_summary_fill
    ...
    def test_get_success_fill(self):
        """성공 채우기가 올바르게 생성됨"""
        from core.shared.io.excel.styles import get_success_fill
    ...
    def test_get_warning_fill(self):
        """경고 채우기가 올바르게 생성됨"""
        from core.shared.io.excel.styles import get_warning_fill
    ...
    def test_get_danger_fill(self):
        """위험 채우기가 올바르게 생성됨"""
        from core.shared.io.excel.styles import get_danger_fill
    ...
    def test_get_abuse_fill(self):
        """악성 채우기가 올바르게 생성됨"""
        from core.shared.io.excel.styles import get_abuse_fill
    ...
    def test_get_error_fill(self):
        """에러 채우기가 올바르게 생성됨"""
        from core.shared.io.excel.styles import get_error_fill
    ...
    def test_get_info_fill(self):
        """정보 채우기가 올바르게 생성됨"""
        from core.shared.io.excel.styles import get_info_fill
    ...
    def test_get_thin_border(self):
        """얇은 테두리가 올바르게 생성됨"""
        from core.shared.io.excel.styles import get_thin_border
    ...
    def test_get_center_alignment_default(self):
        """중앙 정렬이 기본값으로 생성됨"""
        from core.shared.io.excel.styles import get_center_alignment
    ...
    def test_get_basic_header_style(self):
        ...
        from core.shared.io.excel.styles import get_basic_header_style
    ...
    def test_get_header_style(self):
        """헤더 스타일이 모든 요소를 포함"""
        from core.shared.io.excel.styles import get_header_style
    ...
    def test_get_center_header_style(self):
        """중앙 정렬 헤더 스타일"""
        from core.shared.io.excel.styles import get_center_header_style
    ...
    def test_get_data_cell_style(self):
        """데이터 셀 스타일"""
        from core.shared.io.excel.styles import get_data_cell_style
    ...
    def test_get_summary_cell_style(self):
        """요약 셀 스타일"""
        from core.shared.io.excel.styles import get_summary_cell_style
...
class TestStatusStyles:
    ...
    def test_create_status_style_success(self):
        """성공 상태 스타일"""
        from core.shared.io.excel.styles import create_status_style
...
class TestNumberFormats:
    ...
    def test_number_format_integer(self):
        """정수 포맷이 정의됨"""
        from core.shared.io.excel.styles import NUMBER_FORMAT_INTEGER
    ...
    def test_number_format_decimal(self):
        """소수점 포맷이 정의됨"""
        from core.shared.io.excel.styles import NUMBER_FORMAT_DECIMAL
    ...
    def test_number_format_currency(self):
        """통화 포맷이 정의됨"""
        from core.shared.io.excel.styles import NUMBER_FORMAT_CURRENCY

        assert NUMBER_FORMAT_CURRENCY is not None

    def test_number_format_percent(self):
        """퍼센트 포맷이 정의됨"""
        from core.shared.io.excel.styles import NUMBER_FORMAT_PERCENT
    ...
    def test_number_format_date(self):
        """날짜 포맷이 정의됨"""
        from core.shared.io.excel.styles import NUMBER_FORMAT_DATE

        assert NUMBER_FORMAT_DATE is not None

    def test_number_format_datetime(self):
        """날짜시간 포맷이 정의됨"""
        from core.shared.io.excel.styles import NUMBER_FORMAT_DATETIME

        assert NUMBER_FORMAT_DATETIME is not None

    def test_number_format_text(self):
        """텍스트 포맷이 정의됨"""
        from core.shared.io.excel.styles import NUMBER_FORMAT_TEXT

        assert NUMBER_FORMAT_TEXT == "@"

    def test_number_format_status(self):
        """상태 포맷이 정의됨"""
        from core.shared.io.excel.styles import NUMBER_FORMAT_STATUS
...
class TestAlignmentConstants:
    ...
    def test_align_center(self):
        """중앙 정렬 상수가 정의됨"""
        from core.shared.io.excel.styles import ALIGN_CENTER
    ...
    def test_align_left(self):
        """왼쪽 정렬 상수가 정의됨"""
        from core.shared.io.excel.styles import ALIGN_LEFT

        assert ALIGN_LEFT.horizontal == "left"

    def test_align_right(self):
        """오른쪽 정렬 상수가 정의됨"""
        from core.shared.io.excel.styles import ALIGN_RIGHT

        assert ALIGN_RIGHT.horizontal == "right"

    def test_align_wrap(self):
        """줄바꿈 정렬 상수가 정의됨"""
        from core.shared.io.excel.styles import ALIGN_WRAP

        assert ALIGN_WRAP.wrap_text is True

    def test_align_left_wrap(self):
        """왼쪽 줄바꿈 정렬 상수가 정의됨"""
        from core.shared.io.excel.styles import ALIGN_LEFT_WRAP
    ...
    def test_align_center_wrap(self):
        """중앙 줄바꿈 정렬 상수가 정의됨"""
        from core.shared.io.excel.styles import ALIGN_CENTER_WRAP
    ...
    def test_align_right_wrap(self):
        """오른쪽 줄바꿈 정렬 상수가 정의됨"""
        from core.shared.io.excel.styles import ALIGN_RIGHT_WRAP
...
class TestColorConstants:
    ...
    def test_color_header_bg(self):
        """헤더 배경 색상"""
        from core.shared.io.excel.styles import COLOR_HEADER_BG
    ...
    def test_color_header_fg(self):
        """헤더 글자 색상"""
        from core.shared.io.excel.styles import COLOR_HEADER_FG

        assert COLOR_HEADER_FG is not None

    def test_color_success(self):
        """성공 색상"""
        from core.shared.io.excel.styles import COLOR_SUCCESS

        assert COLOR_SUCCESS is not None

    def test_color_warning(self):
        """경고 색상"""
        from core.shared.io.excel.styles import COLOR_WARNING

        assert COLOR_WARNING is not None

    def test_color_danger(self):
        """위험 색상"""
        from core.shared.io.excel.styles import COLOR_DANGER
