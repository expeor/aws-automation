"""
tests/core/auth/test_datadog_client.py - Datadog 클라이언트 테스트
"""
...
class TestDatadogClientManager:
    ...
    def test_initialization(self):
        """초기화 테스트"""
        from core.auth.datadog_client import DatadogClientManager
    ...
    @patch("core.auth.datadog_client.DatadogClientManager._validate_and_create_client")
...
class TestGetDatadogClients:
    ...
    @patch("core.auth.datadog_client.DatadogClientManager")
    def test_calls_manager(self, mock_manager_class):
        """매니저를 올바르게 호출"""
        from core.auth.datadog_client import get_datadog_clients
