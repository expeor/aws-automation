...
class TestProfileGroupsManager:
    ...
    def test_singleton_pattern(self, reset_singleton):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            with patch("core.tools.cache.get_cache_path", return_value=Path(tmpdir) / "groups.json"):
                manager1 = ProfileGroupsManager()
                manager2 = ProfileGroupsManager()

                assert manager1 is manager2

    def test_add_group(self, reset_singleton):
        """그룹 추가"""
        from core.tools.history.profile_groups import ProfileGroupsManager
    ...
    def test_add_duplicate_group(self, reset_singleton):
        """중복 그룹 추가 실패"""
        from core.tools.history.profile_groups import ProfileGroupsManager
    ...
    def test_add_empty_profiles(self, reset_singleton):
        """빈 프로필 목록으로 추가 실패"""
        from core.tools.history.profile_groups import ProfileGroupsManager
    ...
    def test_add_max_groups(self, reset_singleton):
        """최대 그룹 수 초과"""
        from core.tools.history.profile_groups import ProfileGroupsManager
    ...
    def test_add_truncates_profiles(self, reset_singleton):
        """프로필 개수 제한"""
        from core.tools.history.profile_groups import ProfileGroupsManager
    ...
    def test_update_group_name(self, reset_singleton):
        """그룹 이름 변경"""
        from core.tools.history.profile_groups import ProfileGroupsManager
    ...
    def test_update_group_profiles(self, reset_singleton):
        """그룹 프로필 변경"""
        from core.tools.history.profile_groups import ProfileGroupsManager
    ...
    def test_update_nonexistent_group(self, reset_singleton):
        """존재하지 않는 그룹 업데이트"""
        from core.tools.history.profile_groups import ProfileGroupsManager
    ...
    def test_update_duplicate_name(self, reset_singleton):
        """중복 이름으로 변경 실패"""
        from core.tools.history.profile_groups import ProfileGroupsManager
    ...
    def test_remove_group(self, reset_singleton):
        """그룹 삭제"""
        from core.tools.history.profile_groups import ProfileGroupsManager
    ...
    def test_remove_nonexistent_group(self, reset_singleton):
        """존재하지 않는 그룹 삭제"""
        from core.tools.history.profile_groups import ProfileGroupsManager
    ...
    def test_get_by_name_found(self, reset_singleton):
        """이름으로 그룹 찾기 - 존재"""
        from core.tools.history.profile_groups import ProfileGroupsManager
    ...
    def test_get_by_name_not_found(self, reset_singleton):
        """이름으로 그룹 찾기 - 없음"""
        from core.tools.history.profile_groups import ProfileGroupsManager
    ...
    def test_get_all(self, reset_singleton):
        """전체 그룹 목록"""
        from core.tools.history.profile_groups import ProfileGroupsManager
    ...
    def test_get_by_kind(self, reset_singleton):
        """타입별 그룹 필터링"""
        from core.tools.history.profile_groups import ProfileGroupsManager
    ...
    def test_move_up(self, reset_singleton):
        """그룹 순서 올리기"""
        from core.tools.history.profile_groups import ProfileGroupsManager
    ...
    def test_move_up_first_item(self, reset_singleton):
        """첫 번째 아이템은 올리기 불가"""
        from core.tools.history.profile_groups import ProfileGroupsManager
    ...
    def test_move_down(self, reset_singleton):
        """그룹 순서 내리기"""
        from core.tools.history.profile_groups import ProfileGroupsManager
    ...
    def test_move_down_last_item(self, reset_singleton):
        """마지막 아이템은 내리기 불가"""
        from core.tools.history.profile_groups import ProfileGroupsManager
    ...
    def test_clear(self, reset_singleton):
        """전체 초기화"""
        from core.tools.history.profile_groups import ProfileGroupsManager
    ...
    def test_persistence(self, reset_singleton):
        """저장 및 로드 테스트"""
        from core.tools.history.profile_groups import ProfileGroupsManager

        with tempfile.TemporaryDirectory() as tmpdir:
            file_path = Path(tmpdir) / "groups.json"
