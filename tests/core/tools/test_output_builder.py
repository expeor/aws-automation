...
from core.shared.io.output.builder import (
    DatePattern,
    OutputPath,
    OutputResult,
...
class TestOutputPathBuild:
    ...
    def test_build_with_date_string(self, tmp_path):
        ...
        with (
            ...
            patch("core.shared.io.output.builder.datetime") as mock_dt,
        ):
...
class TestWeeklyDatePattern:
    ...
    def test_first_week_of_month(self):
        """월 첫째 주 테스트"""
        with patch("core.shared.io.output.builder.datetime") as mock_dt:
            # 2025년 12월 1일 (월요일)
...
class TestPrintReportComplete:
    ...
    def test_single_path_output(self, capsys):
        """단일 경로 출력"""
        from core.shared.io.output.builder import print_report_complete
...
class TestSingleReportDirectory:
    ...
    def test_creates_reports_subdirectory(self, tmp_path):
        """reports 하위 디렉토리 생성"""
        from core.shared.io.output.builder import single_report_directory
