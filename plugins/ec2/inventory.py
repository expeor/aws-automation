...
def run(ctx) -> None:
    ...
    resources = [
        ResourceDef(
            ...
            row_mapper=lambda i: [
                i.account_id, i.account_name, i.region, i.instance_id, i.name,
                i.instance_type, i.state, i.private_ip, i.public_ip, i.vpc_id, i.platform,
            ],
        ),
        ResourceDef(
            name="Security Group",
            ...
            row_mapper=lambda sg: [
                sg.account_id, sg.account_name, sg.region, sg.group_id, sg.group_name,
                sg.vpc_id, sg.description[:50] + "..." if len(sg.description) > 50 else sg.description,
