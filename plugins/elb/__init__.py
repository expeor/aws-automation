...
TOOLS = [
    ...
    # Legacy tools (deprecated - use "미사용 ELB" instead)
    {
        "name": "ALB 미사용 분석",
        "name_en": "Unused ALB Analysis",
        "description": "타겟이 없는 ALB 탐지 (→ 미사용 ELB 권장)",
        "description_en": "Detect ALBs without targets (use Unused ELB)",
        "permission": "read",
        "module": "alb_unused",
        "area": "unused",
        "sub_service": "alb",
    ...
    },
    {
        ...
        "description": "타겟이 없는 NLB 탐지 (→ 미사용 ELB 권장)",
        "description_en": "Detect NLBs without targets (use Unused ELB)",
        "permission": "read",
        "module": "nlb_unused",
        "area": "unused",
        "sub_service": "nlb",
    ...
    },
    {
        ...
        "description": "인스턴스가 없는 CLB 탐지 (→ 미사용 ELB 권장)",
        "description_en": "Detect CLBs without instances (use Unused ELB)",
        "permission": "read",
        "module": "clb_unused",
        "area": "unused",
        "sub_service": "clb",
