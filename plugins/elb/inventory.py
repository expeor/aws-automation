    ...
    resources = [
        ResourceDef(
            ...
            row_mapper=lambda lb: [
                lb.account_id, lb.account_name, lb.region, lb.name, lb.lb_type,
                lb.scheme, lb.state, lb.vpc_id, lb.dns_name, lb.total_targets, lb.healthy_targets,
            ],
        ),
        ResourceDef(
            name="Target Group",
            ...
            row_mapper=lambda tg: [
                tg.account_id, tg.account_name, tg.region, tg.name, tg.target_type,
                tg.protocol, tg.port, tg.vpc_id, tg.total_targets,
                tg.healthy_targets, tg.unhealthy_targets, len(tg.load_balancer_arns),
            ],
        ),
    ]
