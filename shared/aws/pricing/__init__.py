...
사용법:
    from shared.aws.pricing import get_ec2_monthly_cost, get_ebs_monthly_cost
    from shared.aws.pricing import get_nat_monthly_cost, get_endpoint_monthly_cost
    from shared.aws.pricing import get_secret_monthly_cost, get_kms_key_monthly_cost
    from shared.aws.pricing import get_ecr_monthly_cost, get_hosted_zone_monthly_cost
    ...
    # 통합 가격 서비스 사용
    from shared.aws.pricing import pricing_service
